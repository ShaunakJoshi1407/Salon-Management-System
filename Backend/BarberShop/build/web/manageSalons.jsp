...
<html>  
    ...
    <body>
        ...
        <sql:query var="rs" dataSource="${db}">Select * from salon where approved = "YES"</sql:query>
         
        <div class="container text-center">    
            <h2>Manage Salons</h2> <br>
            <div class="row">   
              <c:forEach items="${rs.rows}" var="act">
                  <div class="col-sm-4" style="height: 500px;">
                        ...
                        <h4 class="sal_name"><c:out value="${act.sal_city}"></c:out></h4>
                        <button id="${act.sal_contact}" class="btn btn-danger approveSalon" value="${act.sal_email}">Remove</button>
                        <h3 class="${act.sal_contact}" style="color: red; text-align: center;"></h3>
                </div>
              </c:forEach> 
            </div>
          </div>
        ...
        <script type="text/javascript">
            $(document).on('click', 'button',function(e){
                ...
                var res = confirm('All data of salon will be removed permanently.\nDo you want to remove salon?');
                if(res){
                    $.ajax({
